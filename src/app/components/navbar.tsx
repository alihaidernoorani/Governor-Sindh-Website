...
export default function Navbar() {
  ...
  return (
  // Div to colour bar full width
   <div className="fixed w-screen z-30 bg-[#044e83]">
      <div className="m-auto text-white flex h-16  items-center justify-around md:h-20 mx-32">
      {/* Logo Section */}
