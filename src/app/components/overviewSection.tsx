...
export default function CourseDescription() {
    return (
        ...
        {/* Generative AI Intro */}
        <h1 className="text-[#044e83] text-xl lg:text-3xl font-extrabold text-center mx-2 lg:mx-32 pb-14">
        ...
        <p className="text-justify text-normal lg:text-lg leading-7 tracking-widest mx-2 lg:mx-32">
        ...
        <div className="flex flex-col justify-around gap-3 lg:flex-row py-6 mx-auto">
