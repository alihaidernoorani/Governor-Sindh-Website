...
export default function overviewSection() {
    return (
        ...
        <div className="flex flex-col justify-around gap-3 lg:flex-row mx-2 md:mx-32">
          <Card src="/images/money.png" alt="Representation of financial growth" />
          <Card src="/images/solopreneur.png" alt="Solopreneurship concept" />
          <Card src="/images/IT class.png" alt="IT class in session" />
        </div>
      </section>
    )
}
